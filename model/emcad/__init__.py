"""Copied from https://github.com/SLDGroup/EMCAD.
"""
...
from ..cascade.pvt_v2 import pvt_v2_b0, pvt_v2_b1, pvt_v2_b2, pvt_v2_b3, pvt_v2_b4, pvt_v2_b5
...
class EMCADNet(nn.Module):
    def __init__(
        ...
        pretrained_dir = osp.expandvars("$PRETRAIN_HOME")
