"""Copied from https://github.com/SLDGroup/CASCADE.
"""
...
from ..trans_unet.vit_seg_modeling import CONFIGS as CONFIGS_ViT_seg, SegmentationHead, Transformer
...
class PVT_CASCADE(nn.Module):
    def __init__(self, in_channels: int, num_classes: int):
        ...
        path = osp.expandvars(osp.join("$PRETRAIN_HOME", "pvt_v2_b2.pth"))
        ...
        self.out_head1 = nn.Conv2d(512, num_classes, 1)
        self.out_head2 = nn.Conv2d(320, num_classes, 1)
        self.out_head3 = nn.Conv2d(128, num_classes, 1)
        self.out_head4 = nn.Conv2d(64, num_classes, 1)
...
class TransCASCADE(nn.Module):
    def __init__(self, in_channels: int, num_classes: int, **kwargs):
        ...
        self.transformer = Transformer(config, self.img_size, False)
        ...
        logger.info(f"Loaded pretrained weights from {config.pretrained_path}")
